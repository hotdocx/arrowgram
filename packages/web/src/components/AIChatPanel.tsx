...
export function AIChatPanel() {
    const [messages, setMessages] = useState<Message[]>([
        { role: 'assistant', text: 'Hello! I am the Arrowgram AI. Describe a commutative diagram, and I will generate it for you.' }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const responseSpec = await generateDiagram(userMsg.text, spec);
            
            // Validate if it is JSON
            try {
                JSON.parse(responseSpec);
                setSpec(responseSpec);
                ...
                console.error("Invalid JSON from AI:", responseSpec);
